...
public class EchoServer extends AbstractServer {
    ...
    protected void clientConnected(ConnectionToClient client) {
        ...
        System.out.println("connected: " + client.getInetAddress().getHostName() + ":" + client.getInetAddress().getHostAddress());
    }

    @Override
    protected synchronized void clientDisconnected(ConnectionToClient client) {
        connectedClients.remove(client);
        System.out.println("disconnected: " + client.getInetAddress().getHostName() + ":" + client.getInetAddress().getHostAddress());
    }
    ...
    public synchronized ArrayList<String> getConnectedClients() {
        ...
        synchronized (connectedClients) {
            for (ConnectionToClient client : connectedClients) {
                clientInfoList.add(client.getInetAddress().getHostName() + ":" + client.getInetAddress().getHostAddress());
            }
        }
